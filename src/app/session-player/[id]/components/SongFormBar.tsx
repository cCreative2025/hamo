...
export function SongFormBar({
  ...
  layerCount = 0, onLayerOpen, onEditForm,
}: SongFormBarProps) {
  ...
  return (
    <>
      <div className="flex-shrink-0 bg-neutral-900 px-3 py-2 flex items-center gap-2">
        ...
        {/* Form edit button (creator only) */}
        {isCreator && onEditForm && (
          <button
            onClick={onEditForm}
            className="flex-shrink-0 p-1.5 rounded-lg bg-neutral-700 hover:bg-neutral-600 text-neutral-400 hover:text-white transition-colors"
            title="송폼 편집"
          >
